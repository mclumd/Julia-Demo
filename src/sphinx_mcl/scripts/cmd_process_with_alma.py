...
def start_node():
	...
	pub_arm = rospy.Publisher('/arm_cmd', String, queue_size=10)
        ...
        alma_node_cmd = rospy.Publisher('/alma_node_cmd',String,queue_size=100)
	rospy.spin()
